...
import (
	"encoding/json"
	"github.com/KenmyZhang/mini-chat/einterfaces"
	"io"
)

const (
	AUTH_SERVICE_WECHAT = "wechat"
)
...
func init() {
	...
	einterfaces.RegisterOauthProvider(AUTH_SERVICE_WECHAT, provider)
}
...
func userFromWeChatUser(wcu *WeChatUser) *model.User{
	...
	user.AuthService = AUTH_SERVICE_WECHAT 
